 ...
 * @LastEditors: Weidows
 * @LastEditTime: 2021-10-12 14:18:42
 * @FilePath: \Java\Java\src\main\java\works\done\transform_charset\TransformCharset.java
...
package demos.transform_charset;
...
public class TransformCharset {
  ...
  public static void main(String[] args) {
    ...
    TransformCharset t = new TransformCharset(path, "UTF-8", "GB2312");
    try {
      t.ifFile();
    } catch (Exception e) {
      e.printStackTrace();
